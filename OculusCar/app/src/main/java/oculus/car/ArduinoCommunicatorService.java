...
//    long startTime = 0;
    ...
    final static String DATA_RECEIVED_INTENT = "oculus.car.intent.action.DATA_RECEIVED";
    final static String SEND_DATA_INTENT = "oculus.car.intent.action.SEND_DATA";
//    final static String DATA_SENT_INTERNAL_INTENT = "oculus.car.internal.intent.action.DATA_SENT";
    final static String DATA_EXTRA = "oculus.car.intent.extra.DATA";
...
//        startTime = 0;
//        mHandler2.postDelayed(mStatusChecker2, 0);
    }
...
//                final byte[] dataToSend = "*090F250F250".getBytes();
//                Intent sendIntent = new Intent(SEND_DATA_INTENT);
...
//        mHandler2.removeCallbacks(mStatusChecker2);
    ...
    private boolean initDevice() {
        ...
        if (mUsbConnection == null) {
            ...
            Toast.makeText(getBaseContext(), getString(R.string.opening_device_failed), Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (!mUsbConnection.claimInterface(usbInterface, true)) {
            ...
            Toast.makeText(getBaseContext(), getString(R.string.claimning_interface_failed), Toast.LENGTH_SHORT).show();
            mUsbConnection.close();
            return false;
        }
    ...
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(getBaseContext(), "start of reciever", Toast.LENGTH_SHORT).show();
            ...
            mHandler = new Handler() {
                public void handleMessage(Message msg) {
                    ...
                    if (msg.what == 10) {
                        ...
                        Toast.makeText(getBaseContext(), "actually send lol", Toast.LENGTH_SHORT).show();
