...
//        ByteArray transferredData = mTransferedDataList.get(position);
//        transferredData.toggleCoding();
//        mTransferedDataList.set(position, transferredData);
...
//
//            String thing = "--" + dateFormat.format(cal.getTime());
//            byte[] now = thing.getBytes();
//
//            byte[] c = new byte[newTransferedData.length + now.length];
//            System.arraycopy(newTransferedData, 0, c, 0, newTransferedData.length);
//            System.arraycopy(now, 0, c, newTransferedData.length, now.length);
//
//            transferedData.add(c);
